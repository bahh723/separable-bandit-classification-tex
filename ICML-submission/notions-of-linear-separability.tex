...
\chicheng{This $L$ notion may be a bit confusing - feel free to edit}
...
\chicheng{And any randomized algorithm must make $\left\lfloor (R/\gamma)^2
\right \rfloor / 2$ mistakes?}
...
\chicheng{Shall we mention the multiclass margin notion that appeared in e.g.~\cite{Crammer-Singer-2003}}
...
separable with a margin $\gamma$, then it is also strongly linearly separable with
...
Equations~\eqref{equation:strong-linear-separability-2} and~\eqref{equation:strong-linear-separability-3} follow from the fact that $w_1' - w_2' = w_1 - w_2$.
