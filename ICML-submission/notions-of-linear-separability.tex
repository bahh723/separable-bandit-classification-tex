...
The notion of strong linear separability is new. Intuitively, strong linear
separability means that, for each $i$, the set of examples with class $i$ and
the set of example of other classes are separated by a linear classifier $w_i$.
...
separable with margin $\gamma$, then they are weakly linearly separable with margin
...
\eqref{equation:weak-linear-separability-2} with margin $\gamma' = 2\gamma$.

Similarly, if $K=2$ and labeled examples are weakly linearly separable with a margin
