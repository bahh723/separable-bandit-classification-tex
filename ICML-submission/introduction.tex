...
\begin{protocol}[h]
\caption{\textsc{Online Multiclass Classification with Bandit Feedback \chicheng{Shall we emphasize linear here?}}
...
\chicheng{I just noted that Theorem 3 of~\cite{Crammer-Singer-2003} actually
has exactly the same upper bound - but it might still make sense to include the
proof here.}
