...
\chicheng{Perhaps cite~\cite{Kakade-Shalev-Shwartz-Tewari-2008}?}
...
%the \textsc{Multiclass Perceptron} algorithm
...
For the case when examples are weakly linearly separable,
...
%inspired by~\cite{Klivans-Servedio-2008},
%In fact, our analysis can
%be viewed as a follow up on their work.
