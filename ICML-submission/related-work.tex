...
% of the contextual bandits problem, 
where the
...
learning literature 
%focus on oracle-efficiency~\citep{Dudik-Hsu-Kale-Karampatziakis-Langford-Reyzin-Zhang-2011,
%Agarwal-Hsu-Kale-Langford-Li-Schapire-2014, Rakhlin-Sridharan-2016,
%Syrgkanis-Krishnamurthy-Schapire-2016,
%Syrgkanis-Luo-Krishnamurthy-Schapire-2016}. Specifically, they 
assume access to
...
information-theoretic regret upper bounds
%%%%%
%under
 for
%%%%%
various settings of $\calF$. On the other hand, it gives an efficient algorithm 
%%%%%
with an 
%%%%%
$O(\sqrt{T})$ regret against the benchmark of
...
gives
%%%%%
an algorithm with $O(\sqrt{T})$ mistake bound in the
