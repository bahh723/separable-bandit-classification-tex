...
predictions, the algorithms makes a prediction uniformly at random from
$\cbr{1,\ldots,K}$.
...
such that:
\begin{enumerate}
  \item $((\phi(x_1), y_1), (\phi(x_2), y_2), \dots, (\phi(x_T), y_T))$,
  the set of examples in $L$ after feature transformation $\phi$,
  is strongly linearly separable with margin $\gamma$,
