...
\forall t \in \cbr{1,2,\dots,T}, y_t = i \quad \Rightarrow \quad p_i(y_t) \ge \frac{\gamma'}{2} \; , \\
\label{equation:poly-neg-i}
\forall t \in \cbr{1,2,\dots,T}, y_t \neq i \quad \Rightarrow \quad p_i(y_t) \le -\frac{\gamma'}{2} \; .
\end{align}
...
$$
R_i^+ = \!\!\!\!\! \!\!\!\!\! \bigcap_{j \in \cbr{1,2,\dots,K} \setminus \cbr{i}} \cbr{x \in \B(0,1) ~:~ \ip{w_i^* - w_j^*}{x} \ge \gamma},
$$
and all examples from the remaining classes lie in
$$
R_i^- = \!\!\!\!\! \!\!\!\!\! \bigcup_{j \in \cbr{1,2,\dots,K} \setminus \cbr{i}} \cbr{x \in \B(0,1) ~:~ \ip{w_i^* - w_j^*}{x} \le -\gamma}.
$$
...
approximates on $\B(0,1)$ a scalar multiple of the indicator function of the
...
\begin{enumerate}
\item $p(x) \ge 1/2$ \\ for all $\displaystyle x \in R^+ = \bigcap_{i=1}^m \left\{ x \in \B(0,1) ~:~  \ip{v_i}{x} \ge \gamma \right\}$,
\item $p(x) \le -1/2$ \\ for all $\displaystyle x \in R^- = \bigcup_{i=1}^m \left\{ x \in \B(0,1) ~:~  \ip{v_i}{x} \le - \gamma \right\}$,
...
for all $\displaystyle x \in R^+ = \bigcap_{i=1}^m \left\{ x \in \B(0,1) ~:~ \ip{v_i}{x} \ge \gamma \right\}$,

\item $\displaystyle p(x) \le - 1/2$ \\
for all $\displaystyle x \in R^- = \bigcup_{i=1}^m \left\{ x \in \B(0,1) ~:~ \ip{v_i}{x} \le - \gamma \right\}$,
