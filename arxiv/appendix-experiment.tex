...
\begin{figure}[h!]
    ...
    \begin{subfigure}[b]{0.25\textwidth}
        ...
        \begin{center}
        \includegraphics[width=\textwidth, trim={0, 0cm, 0, 0}, clip]{figures/strong_banditron_points.pdf}
    ...
    \begin{subfigure}[b]{0.25\textwidth}
        \captionsetup{justification=centering}
        \centering
        \includegraphics[width=\textwidth, trim={0, 0cm, 0, 0}, clip]{figures/weak_banditron_points.pdf}
...
\begin{figure}[h!]
    ...
    \begin{subfigure}[b]{0.25\textwidth}
        \captionsetup{justification=centering}
        \begin{center}
        \includegraphics[width=\textwidth, trim={0, 0cm, 0, 0}, clip]{figures/strong_linear_ova_points.pdf}
        \caption{Strongly separable case}
        \end{center}
    \end{subfigure}
    \begin{subfigure}[b]{0.25\textwidth}
        \captionsetup{justification=centering}
        \centering
        \includegraphics[width=\textwidth, trim={0, 0cm, 0, 0}, clip]{figures/weak_linear_ova_points.pdf}
         \caption{Weakly separable case}
    \end{subfigure}
    \captionsetup{justification=centering}
...
\begin{figure}[h!]
    ...
    \begin{subfigure}[b]{0.25\textwidth}
        \captionsetup{justification=centering}
        \begin{center}
        \includegraphics[width=\textwidth, trim={0, 0cm, 0, 0}, clip]{figures/strong_rational_ova_points.pdf}
        \caption{Strongly separable case}
        \end{center}
    \end{subfigure}
    \begin{subfigure}[b]{0.25\textwidth}
        \captionsetup{justification=centering}
        \centering
        \includegraphics[width=\textwidth, trim={0, 0cm, 0, 0}, clip]{figures/weak_rational_ova_points.pdf}
         \caption{Weakly separable case}
    \end{subfigure}
    \captionsetup{justification=centering}
