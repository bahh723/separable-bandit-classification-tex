...
We use symbols $[K]=\{1,2,\dots,K\}$ for strong labels and $[\overline{K}]
=\{\overline{1},
...
\begin{align*}
& y_t \in [K] \Longrightarrow \forall i \in [K] \setminus \{y_t\} \quad \ip{w_{y_t}}{x_t}  > \ip{w_i}{x_t} \; , \\
& \text{and} \\
& y_t \in [\overline{K}] \Longrightarrow \exists i \in [K] \quad \ip{w_i}{x_t} > \ip{w_{\overline{y_t}}}{x_t} \; ?
\end{align*}
\end{framed}
\end{figure}
