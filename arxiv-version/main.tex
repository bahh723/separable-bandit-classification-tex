...
2(R/\gamma)^2 \right \rfloor$ mistakes. Another folklore result is that
\textsc{Multiclass Perceptron} is an optimal algorithm in the sense that any
deterministic algorithm makes $\left\lfloor 2(R/\gamma)^2 \right \rfloor$
...
\begin{algorithm}[h]
\caption{\textsc{Full-Information Multiclass Classification}
