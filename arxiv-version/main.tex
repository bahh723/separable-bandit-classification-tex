...
an inequality $(\sum_{i=1}^n a_i)^2 \le n \sum_{i=1}^n a_i^2$ valid
for any real numbers $a_1, a_2, \dots, a_n$. (The latter inequality follows from the inequality
between arithmetic mean and qudratic mean, $\frac{1}{n} \sum_{i=1}^n a_i \le \sqrt{\frac{1}{n} \sum_{i=1}^n a_i^2}$.)
We have
\begin{align*}
\norm{\sum_{i=1}^n p_i}^2 = \left( \norm{\sum_{i=1}^n p_i} \right)^2 \le \left(\sum_{i=1}^n \norm{p_i} \right)^2 \le n \sum_{i=1}^n \norm{p_i}^2 \; .
\end{align*}
\end{proof}
