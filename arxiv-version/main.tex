...
\item $\deg(p) \le m (2 \left\lceil \frac{1}{2} \log(4m + 1) \right\rceil + 1) (2 \left \lceil \log(1/\gamma) \right \rceil + 1)$
\item $\norm{p} \le ???$
\end{enumerate}
\end{theorem}
...
For any integer $n \ge 0$ and $r = 2 \left\lceil \frac{1}{2} \log(4m + 1) \right\rceil + 1$,
\begin{enumerate}
