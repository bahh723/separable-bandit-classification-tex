...
towards this problem. We identify two notions of linear separability:
...
based on a reduction from weak linear separability to strong linear separability
via an infinite dimensional monomial feature map, which in turn is inspired by
