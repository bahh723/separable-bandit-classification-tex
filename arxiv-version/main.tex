...
\begin{enumerate}
\item $\displaystyle p(x) \ge m^{\frac{1}{2} m \log^2(1/\gamma)}$
for all $\displaystyle x \in \bigcap_{i=1}^m \left\{ x \in \R^d ~:~ \norm{x} \le 1, \ \ip{v_i}{x} \ge \gamma \right\}$

\item $\displaystyle p(x) \le - m^{\frac{1}{2} m \log^2(1/\gamma)}$
for all $\displaystyle x \in \bigcup_{i=1}^m \left\{ x \in \R^d ~:~ \norm{x} \le 1, \ \ip{v_i}{x} \le - \gamma \right\}$

\item $\deg(p) \le m (2 \left\lceil \frac{1}{4} \log_2(4m + 1) \right\rceil + 1) (2 \left \lceil \log(1/\gamma) \right \rceil + 1)$
\item $\norm{p} \le ???$
\end{enumerate}
\end{theorem}
...
\end{align*}
Let $r = 2 \left\lceil \frac{1}{4} \log_2(4m + 1) \right\rceil + 1$ and $s = \left \lceil \log(1/\gamma) \right \rceil$.
...
$$
Clearly, $\deg(P_n) = 2n+1$. Thus, $\deg(A_{n,k})$ and $\deg(B_{n,k})$ are at
most  $(2n+1)k$, and therefore $\deg(p) \le m (2s+1) r$.
...
\begin{proposition}[Properties of $S_{n,r}$ and $B_{n,r}$]
\label{proposition:properties-of-s-n-r}
...
part 2 of~\autoref{proposition:properties-of-p-n}, $c \in [0,\frac{1}{4^r}]$. Since
...
$$
where the second last inequality follows from part 3 of \autoref{proposition:properties-of-p-n}.
...
$$
where $c = \left( - \frac{P_n(z)}{P_n(-z)}\right)^r$. Since $z \in [1,2^n]$, by
part 2 of~\autoref{proposition:properties-of-p-n}, $c \in [0,\frac{1}{4^r}]$. By
...
$$
where the last inequality follows from part 3 of \autoref{proposition:properties-of-p-n}.
\end{enumerate}
\end{proof}

To prove parts 1 and 2 of \autoref{theorem:polynomial-approximation-1}
note that \autoref{proposition:properties-of-s-n-r} implies that
\begin{align*}
|p(x)|
...
\end{align*}
Since $p(x)$ and $Q(x)$ have the same sign, it remains to prove that
\begin{align}
\label{equation:rational-margin-1}
Q(x) & \ge \frac{1}{2} && \text{for all} \ x \in \bigcap_{i=1}^m \left\{ x \in \R^d ~:~ \norm{x} \le 1, \ \ip{v_i}{x} \ge \gamma \right\} \; , \\
\label{equation:rational-margin-2}
Q(x) & \le -\frac{1}{2} && \text{for all} \ x \in \bigcup_{i=1}^m \left\{ x \in \R^d ~:~ \norm{x} \le 1, \ \ip{v_i}{x} \le - \gamma \right\} \; .
\end{align}
Consider any $x \in \bigcap_{i=1}^m \left\{ x \in \R^d ~:~ \norm{x} \le 1, \ \ip{v_i}{x} \ge \gamma \right\}$. Then,
$\frac{\ip{v_i}{x}}{\gamma} \in [1, \frac{1}{\gamma}]$.
By part 1 of \autoref{proposition:properties-of-s-n-r}, $S_{s,r}\left(\frac{\ip{v_i}{x}}{\gamma}\right) \in [1, 1 + \frac{1}{2m}]$
and in particular $S_{s,r}\left(\frac{\ip{v_i}{x}}{\gamma}\right) \ge 1$.
Thus, $Q(x) = \left( \sum_{i=1}^m S_{s,r}\left(\frac{\ip{v_i}{x}}{\gamma}\right) \right) - (m - 1/2) \ge m - (m - 1/2) = 1/2$.

Consider any $x \in \bigcup_{i=1}^m \left\{ x \in \R^d ~:~ \norm{x} \le 1, \ \ip{v_i}{x} \le - \gamma \right\}$.
Observe that $\frac{\ip{v_i}{x}}{\gamma} \in [-\frac{1}{\gamma}, \frac{1}{\gamma}]$.
TODO
