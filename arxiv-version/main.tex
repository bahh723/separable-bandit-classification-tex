...
However, if $K \ge 3$ there exists a set of labeled examples in an inner product
space that is linearly separable with a positive margin $\gamma$ but it is not
strongly linearly separable for any positive $\gamma$. Such set of examples is
shown in Figure~\ref{figure:linearly-separable-examples-with-margin}.
